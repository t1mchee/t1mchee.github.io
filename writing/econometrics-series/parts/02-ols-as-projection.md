...
<div class="econ-widget"
     ...
     data-caption="Drag the plane tilt or the direction of $\mathbf{y}$. The residual $\mathbf{r}$ always lands perpendicular to the plane. The readout shows $\mathbf{r}\cdot\mathbf{x}_1$ and $\mathbf{r}\cdot\mathbf{x}_2$ pinned at zero no matter where you move."></div>
